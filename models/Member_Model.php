  ...
  class Member_Model extends CI_Model {
    ...
    public function query_call($controller_model, $function, $data = null)
    {
        ...
        $query = $this->db->query("
                ...
                WHERE a.module = '$module' AND a.controller_model = '$controller_model' AND a.function = '$function' AND b.enable = '1' ORDER BY b.seq
        ");
