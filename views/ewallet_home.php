               ...
               echo $this->session->userdata('message') <> '' ? $this->session->userdata('message') : ''; 
                    ...
                    <center>
                      <br>
                        ...
                        <button type="" class="btn" style="margin-top: 5px;" onclick="location.href = '<?php echo site_url('main_c/ewallet_old')?>';" >Reset</button><br>
                        <button type="" class="btn" style="margin-top: 5px;" onclick="location.href = '<?php echo $assign ?>';" >Assign Member to E Wallet</button><br>
                      </center>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                              ...
                              <table id="ahseh" class="table table-bordered table-hover">
                                ...
                                <tr>
                                    ...
                                    ?>
                                    <a href="<?php echo site_url('main_c/full_details')?>?AccountNo=<?php echo $row->AccountNo?>"><button title="View" type="button" class="btn btn-xs btn-primary">E Wallet Card <i class="fa fa-eye"></i></button></a>
                                    </td>
                                    <td style="text-align:center">
