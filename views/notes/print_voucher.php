                    ...
                    <div class="panel panel-success coupon_success">
                        <div class="panel-heading">
                            <div class="col-md-12 panel-title" id="title">
                                <center style="font-size:20px">PANDA</center>
                            </div>
                        </div>
                        <div class="panel-heading" id="head">
                            <div class="col-md-12 panel-title" id="title">
                                <h2><small style="float:left;">&ensp;RM</small></h2>
                                <center>
                                <span class="valuetext">20</span>
                                <center>
                            </div>
                        </div>
                        <div class="panel-body">
                            ...
                            <div class="boxed">
                                <center><b>10.10.2016 Monday</b></center>
                            </div>
                            <div class="issue" style="margin: 3px;">
                                <p>Issued On <span style="margin-left: 15px;">: 10.10.2016 00:00:00</span></p>
                                <p>Issued By <span style="margin-left: 17px;">: ADMIN</span></p>
                            </div>
                            <hr>
                            <div class="term">
                        ...
                        <div class="panel-footer">
                            ...
                            <div class="foot">
                                ...
                                Name <span style="margin-left: 85px;">: TAN</span><br>
                                NRIC <span style="margin-left: 88px;">: 23423423-4234234</span><br>
                                Point Balance<span style="margin-left: 33px;">: 500</span>
                            </div>
                            <div class="coupon_success_footertext">
                                <center>
                                    <svg class="barcode"
                                      jsbarcode-value="HELLO!"
                                      jsbarcode-width="3"
                                      jsbarcode-height="80"
