              ...
              <tbody>
                ...
                <tr>
                  <td>
                    ...
                    data-name="<?php echo $row->template_name?>"
                    data-message="<?php echo $row->message?>"
                    data-message_guid="<?php echo $row->message_guid?>"  
                    data-contact="<?php echo $row->contact?>"
                    data-contact_guid="<?php echo $row->contact_guid?>"
                    data-active="<?php echo $row->set_active?>"
                    >
                    <i class="glyphicon glyphicon-pencil"></i></button>

                    <button title="View List" onclick="window.location.href='<?php echo site_url('Sms_c/sending_list?guid='.$row->guid)?>'" type="button" class="btn btn-xs btn-info" >
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body form">
                <form action="<?php echo site_url('Sms_c/sending_template_form')?>" method="POST" id="form" class="form-horizontal">
                    ...
                    <div class="form-body">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-9" >
                                <select id="message_select" name="message_select" class="form-control" required>
                                <option required name="message_select_exist" selected data-default style="display: none;" >Select Template</option>
                                <?php foreach($message_select->result() as $row)
                                { 
                                  ?>
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3">Contact Template </label>
                            <div class="col-md-9" >
                                <select id="contact_select" name="contact_select" class="form-control" required>
                                <option required name="contact_select_exist" selected data-default style="display: none;" >Select Template</option>
                                <?php foreach($contact_select->result() as $row)
                                { 
                                  ?>
                                  <option value="<?php echo $row->guid?>"><?php echo $row->template_name?></option>
                                  <?php
...
<script type="text/javascript">
  ...
  function edit_promo()
  {
    ...
    else
    {
      ...
      modal.find('[name="template_name"]').val(button.data('name'))
      ...
      modal.find('[name="message_select_exist"]').text(button.data('message'))
      modal.find('[name="message_select_exist"]').val(button.data('message_guid'))
      modal.find('[name="contact_select_exist"]').text(button.data('contact'))
      modal.find('[name="contact_select_exist"]').val(button.data('contact_guid'))
