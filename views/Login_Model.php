...
class Login_Model extends CI_Model
{
    ...
    function login_data($username, $userpass)// admin/buyer user
    {
        ...
        $sql = "SELECT a.*,b.`user_group_name`,d.`module_name`,e.`module_group_name`,c.`isenable` FROM panda_b2b.set_user a 
    ...
    function login_data2($username, $userpass)// supplier user
    {
        ...
        $sql = "SELECT SUBSTRING_INDEX(a.supplier_name, ' ->', 1) AS supcode, SUBSTRING_INDEX(a.supplier_name, '-> ', -1) AS supname, a.user_id, b.supplier_group_name, b.user_setup FROM panda_b2b.`set_supplier` a INNER JOIN panda_b2b.`set_supplier_group` b ON a.`supplier_group_guid` = b.`supplier_group_guid` WHERE user_id = '$username' AND user_password = '$userpass' AND a.`isactive` = '1';";
