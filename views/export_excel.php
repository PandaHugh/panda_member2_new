        ...
        <div class="box-body">
          <div class="row">
            ...
            <div class="col-md-6">
              ...
              <span class="help-block"><?php echo form_error('merchant[]') ?></span>
              <br>
                ...
                action="<?php echo site_url('Export_excel_c'); ?>?search">
                    ...
                    <div id="methodBranch" class="desc" style="display: none;">
                        <div class="form-group"  id="div1" >
                            ...
                            <select class="form-control" name="branch[]" id='branch' multiple >
                              ...
                              {
                                ?>
                                  <option value="<?php echo $row['branch_code'] ?>"><?php echo $row['branch_name']; echo "&nbsp (".$row['branch_code'].")"?></option>
                                <?php
                              }
                              ?>
                            </select>
                    ...
                    <div id="methodMerchant" class="desc" style="display: none;">
                       ...
                       <?php if($merchant->num_rows() > 0)
                        ...
                        <div class="form-group"  id="div1" >
                            ...
                            <div class="col-md-9">
                            <select multiple class="form-control" name="merchant[]" id='merchant' >
                              <?php
                              foreach($merchant->result() as $row)
                              {
                                ?>
                                  <option value="<?php echo $row->merchant_id?>"><?php echo $row->merchant_id; ?></option>
                                <?php
                              }
                              ?>
                            </select>
                    ...
                    <button style="margin-left: 15px" title="Search" type="submit" class="btn btn-primary btn-xs" >Search</button>
                  </form>
                    ...
                    <div style="overflow-x:auto;height: 250px" >
                      <table id="" class="table table-bordered table-hover" >
                        ...
                        <tr> 
                            ...
                            <th>Issue Date</th>
                            <?php
                            if(isset($_SESSION['search_type']) && $_SESSION['search_type'] == 'MERCHANT')
                            {
                              ?>
                              <th>Merchant</th>
                              <?php
